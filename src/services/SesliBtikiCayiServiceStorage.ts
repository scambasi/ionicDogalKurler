...
export class BitkiCaylariServiceLocalFile
{
  ...
  addBitkiCayi(id:number,adi:string,aciklama:string,resim:any,ses:any,video:Video[]) 
  {
    ...
    console.log("seslibitkicayi"+bitkiCayi.adi+bitkiCayi.aciklama);
    this.storage.set('seslibitkiCaylari', this.bitkiCaylari)
      .then()
      .catch(
        err => {
  ...
  fetchBitkiCaylari() {
    return this.storage.get('seslibitkiCaylari')
      .then(
